...
При запросах из браузера нужен same-origin proxy либо настройка CORS основного API.
Серверных маршрутов откликов пока нет; их реализация и frontend остаются напарникам.
