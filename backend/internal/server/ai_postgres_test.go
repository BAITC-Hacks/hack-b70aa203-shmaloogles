...
func TestAIFlowPostgres(t *testing.T) {
	...
	if loaded.InitialDescription == nil || *loaded.InitialDescription != description || loaded.Status != "draft" || loaded.ConfirmedAt != nil || loaded.ReadinessScore != 0 {
